  ...
  async function uploadPhoto(ev) {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      try {
        ...
        const { url, imageName } = res.data.data;
        ...
        // Step 3: Construct deployed image URL
        const imageUrl = `https://air-bnb-cloud.s3.ap-south-1.amazonaws.com/image/${imageName}`;
    ...
    // Update the state with new uploaded URLs
    onChange((prev) => [...prev, ...uploadedUrls]);
  }
